...
class MovieRentingSystem {
    ...
    private static final Comparator<Node> comp =
            (a, b) -> {
    ...
    private final TreeSet<Node> rentedSet = new TreeSet<>(comp);
    ...
    public void drop(int shop, int movie)
    {
        ...
        availableByMovie
                .computeIfAbsent(movie, x -> new TreeSet<>(comp))
                .add(node);
    }
